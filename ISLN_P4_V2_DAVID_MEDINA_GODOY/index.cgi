...
my $word_url_param;
	 ...
	 if($seen{$_} > 1){
	     ...
	     print "<span title=\"Núm. apariciones: "."$seen{$_}"."\" style=\"font-size: ${size}pt\;color:black\"><a href=\"list_links.cgi?word=${word_url_param}&section=${section}&one_word=1\"> $_ </a></span>\n";
	 }
     }
